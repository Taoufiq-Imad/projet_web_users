...
let getallusers= ()=>{
                ...
                let divusers=document.querySelector('.row')
                divusers.innerHTML=""
                for (const user of users) {
                    let divuser=  `<div class="col-12 col-md-6 col-lg-3 margin-top">
                    <div class="card " style="width: 100%;">
                        <div class="row">
                            <div class="col-5 col-md-12">
                        <img src="${user.picture.large}" class="card-img-top" alt="...">
                         </div>
                        <div class="card-body col-7 <!-- En-tête du tableau --> col-md-12 ">
                        <h5 class="card-title">${user.name.title}.${user.name.last} ${user.name.first}</h5>
...
let totabl=()=>{
    let divtab=document.querySelector('.row')
...
tab.addEventListener('click',e=>{
    ...
    if (tab.name==1) {
        ...
        tab.name=1
        tab.innerText="affiche form tableau"
        getallusers()
    }
